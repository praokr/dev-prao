...
- 2026.02 모락 학원 바로결제 서비스 개발
- 2025.12 ~ 2026.03 동백전 쿠폰함 고도화
- 2025.12 시스템 관리자 계정 관리 자동화 프로세스 개발
- 2025.11 원격 오픈뱅킹 점검 관리 기능 개발
- 2025.07 ~ 2025.11 동백전 민생회복 소비쿠폰(1차·2차) 발행
- 2025.04 ~ 2025.06 모바일 동백패스(삼성페이)
- 2025.04 비짓부산패스(Visit Busan Pass) API 연동 및 결제·승인·취소 프로세스 개발 
- 2025.03 동백전 오류 모니터링 시스템 구축
- 2025.08 ~ 2025.10 친구와 목표를 세우고 소비를 절약하는 모바일 뱅킹 서비스, CHALLET - `경진대회 1등`
- 2025.06 ~ 2025.08 푸드트럭 실시간 위치 공유 및 스트리밍 서비스, 세이푸트 - `경진대회 2등`
- 2025.06 일기를 쓰고 감정을 분석하는 서비스, 감정일기
- 2025.05 KBO 입문자들을 위한 야구 커뮤니티, BUNT - `경진대회 2등`
  
### 💬 Edu & Work
- 부산은행 모바일뱅킹 공통 프레임워크, 모락 운영 및 개발(2026.01 ~ 현재) 
- 부산은행 동백전 운영 및 개발 (2025.01 ~ 2025.12)
