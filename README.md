...
### 💻 Projects
- 2026.04 ~ 2026.05 금융권 공공 마이데이터 토큰 발급 API 개발
...
- 2025.08 ~ 2025.10 친구와 목표를 세우고 소비를 절약하는 모바일 뱅킹 서비스, CHALLET - `경진대회 1등`
- 2025.06 ~ 2025.08 푸드트럭 실시간 위치 공유 및 스트리밍 서비스, 세이푸트 - `경진대회 2등`
- 2025.06 ~ 2025.06 일기를 쓰고 감정을 분석하는 서비스, 감정일기
- 2025.05 ~ 2025.05 KBO 입문자들을 위한 야구 커뮤니티, BUNT - `경진대회 2등`
