...
- [인덱스 튜닝&lpar;Index Tuning&rpar;](https://prao.tistory.com/entry/%EC%9D%B8%EB%8D%B1%EC%8A%A4-%ED%8A%9C%EB%8B%9D)
- [NL Join, Hash Join, Sort Merge Join, Cartesian Join, Outer Join](https://prao.tistory.com/entry/NL-Join-Hash-Join-Sort-Merge-Join-Cartesian-Join-Outer-Join)
...
### 💻 Projects
- 2026.04 ~ 2026.08 금융권 공공 마이데이터 토큰 발급 API 개발
- 2026.02 ~ 2026.03 모락 학원 바로결제 서비스 개발
- 2025.12 ~ 2026.03 동백전 쿠폰함 고도화
- 2025.12 ~ 2025.12 시스템 관리자 계정 관리 자동화 프로세스 개발
- 2025.11 ~ 2025.11 원격 오픈뱅킹 점검 관리 기능 개발
- 2025.07 ~ 2025.11 동백전 민생회복 소비쿠폰(1차·2차) 발행 프로세스 개발
- 2025.04 ~ 2025.06 모바일 동백패스(삼성페이) 구축 및 개발
- 2025.04 ~ 2025.04 비짓부산패스(Visit Busan Pass) API 연동 및 결제·승인·취소 프로세스 개발 
- 2025.03 ~ 2025.03 동백전 오류 모니터링 시스템 구축 및 개발
- 2024.08 ~ 2024.10 친구와 목표를 세우고 소비를 절약하는 모바일 뱅킹 서비스, CHALLET - `경진대회 1등`
- 2024.06 ~ 2024.08 푸드트럭 실시간 위치 공유 및 스트리밍 서비스, 세이푸트 - `경진대회 2등`
- 2024.06 ~ 2024.06 일기를 쓰고 감정을 분석하는 서비스, 감정일기
- 2024.05 ~ 2024.05 KBO 입문자들을 위한 야구 커뮤니티, BUNT - `경진대회 2등`
  
### 💬 Edu & Work
- 2026.01 ~ 현재     부산은행 모바일뱅킹 공통 프레임워크,인증서(공동인증서,금융인증서,간편인증),정부증명서,디지털OTP,모락 운영 및 개발
- 2025.01 ~ 2025.12 부산은행 동백전 운영 및 개발
- 2024.11 ~ 2025.12 부산은행 신입행원 연수
- 2024.01 ~ 2024.10 삼성 청년 소프트웨어 아카데미(SSAFY) 11기
- 2023.11 ~ 2023.12 우아한테크코스 프리코스 참여
- 2022.01 ~ 2023.03 부산시설공단 전기안전관리자(초급)
- 2015.03 ~ 2021.02 부경대학교 나노융합공학과 졸업
